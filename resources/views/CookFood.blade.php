...
<body>
    ...
    <div class="hero-area">
        ...
        <div class="hero-image">
            <img src="https://burst.shopifycdn.com/photos/breakfast-from-above.jpg?width=1200&format=pjpg&exif=0&iptc=0" alt="">
        ...
        <div class="container">
            <div class="row no-gutters py-5">
                <div class="col-md-10 text-left T-recipes">
                    <a href="trending.html">Trending Recepies</a>
                </div>
            ...
            <div class="row bord-bottom" style="justify-content: space-between;">
                <div class="col-md-2 menu-box ">
                    <div class="menu-image">
                        <img src="https://cdn2.lamag.com/wp-content/uploads/sites/6/2018/03/Screen-Shot-2018-03-09-at-1.39.14-PM.png" alt="">
                        <div class="menu-title">
                            <p>Grilled Mixed Berry Cheesecake Pizza</p>
                        </div>
                        <div class="menu-author">
                            <p>Tanjir islam</p>
                        </div>
                        <div class="menu-ratings">
                            <svg height="20px" xmlns="http://www.w3.org/2000/svg" class="h-5 w-5" viewBox="0 0 20 20" fill="currentColor">
    ...
    <div class="Newest-section">
        <div class="container">
            <div class="row no-gutters py-5">
                <div class="col-md-10 text-left T-recipes">
                    <a href="trending.html">Newest Recepies</a>
                </div>
            ...
            <div class="row bord-bottom" style="justify-content: space-between;">
              <div class="col-md-2 menu-box ">
                    <div class="menu-image">
                        <img src="http://cdn.cnn.com/cnnnext/dam/assets/170302153529-garlic-crab.jpg" alt="">
                        <div class="menu-title">
                            <p>Grilled Mixed Berry Cheesecake Pizza</p>
                        </div>
                        <div class="menu-author">
        ...
        <div class="row">
            <div class="gredient-image">
                <div class="search-bar">
                    ...
                    <input type="text" name="query" value="{{request()->input('query')}}" id="query" placeholder="Search..">
